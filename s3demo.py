...
query1.coalesce(1).write.save("QUERY-01_json",format = "JSON")

# COMMAND ----------

query1.coalesce(1).write.save("QUERY-01",format = 'PARQUET')

# COMMAND ----------

query1.coalesce(1).write.save("QUERY-01-csv",format = 'CSV')
